...
* The original package name 'amit.springframework.spring-rest-client-examples' is invalid and this project uses 'amit.springframework.springrestclientexamples' instead.
